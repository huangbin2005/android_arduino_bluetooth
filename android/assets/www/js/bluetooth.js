...
cordova.define("cordova/plugin/bluetooth", function(require, exports, module) {
     ...
     * @content 发送的内容
     */
    Bluetooth.prototype.write = function(successCallback,failureCallback,socketid,content) {
        return exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [socketid,content]);
    }
